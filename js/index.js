(function() {
  ...
  function Game() {
    ...
    function setElements() {
      ...
      G.$wait = document.getElementById("wait");
    ...
    function setAudio() {
      var base_url = "https://s3-ap-southeast-2.amazonaws.com/herobucket18/";
      G.$soundtrack = document.createElement("audio");
      G.$soundtrack.loop = true;
      G.$soundtrack.volume = 0.8;
      G.$soundtrack.src = base_url + "bg.mp3";
      G.sound_effects = {
        keys: [],
        kills: []
      }
